...
//         $file_content = file_get_contents(get_template_directory_uri() . '/blog_posts_content/' . $i . '.txt');
//
//         $information_repeater = array(
//             array(
//                 'headline_text'     => '',
//                 'headline_sub_text' => '',
...
//
//         $data_fields = array(
//             'information' => $information_repeater,
//         );
//
...
//             'blog_child_gallery' => $blog_child_gallery,
//         );
//
//         update_field('sections', array($acf_field_values), $post_id);
//     }
// }

// if(isset($_GET['fred'])) { add_action('init', 'add_custom_posts'); }
//
//
