<?php $layoutName = 'timber_product_filter' ?>
...
<div class="row row--filter__wrapper product__filter_wrap hideFilter">
  ...
  <div class="secondary__filter_wrap">
    ...
    <div class="secondary__filter">
      ...
      <div class="filter__box filter__box--colour" title="Click a swatch to select">
      ...
      <div class="filter__box filter__box--grade" title="Click a swatch to select">
