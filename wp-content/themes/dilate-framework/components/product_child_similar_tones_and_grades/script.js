(function($) {
  ...
  //       draggable: false,
    ...
    $(".comp_product_child_similar_tones_and_grades .tones__carousel_wrapper").slick(getSliderSettings());
    
    $(".comp_product_child_similar_tones_and_grades .grades__carousel_wrapper").slick(getSliderSettings());
    ...
    $(document).on('click', '.comp_product_child_similar_tones_and_grades .tabs__nav button', function() {
      ...
      $(".comp_product_child_similar_tones_and_grades .tones__carousel_wrapper").slick('unslick');
      $(".comp_product_child_similar_tones_and_grades .grades__carousel_wrapper").slick('unslick');
